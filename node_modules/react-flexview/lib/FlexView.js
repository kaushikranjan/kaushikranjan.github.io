...
var FlexView = /** @class */ (function (_super) {
    ...
    FlexView.prototype.getFlexStyle = function () {
    ...
    FlexView.prototype.getStyle = function () {
        ...
        return __assign({}, this.getFlexStyle(), style, this.props.style);
    };
    FlexView.prototype.getContentAlignmentClasses = function () {
        ...
        var vAlignContent = this.props.vAlignContent && vAlignContentClasses[this.props.vAlignContent];
        var hAlignContent = this.props.hAlignContent && hAlignContentClasses[this.props.hAlignContent];
        return cx(vAlignContent, hAlignContent);
    };
    FlexView.prototype.getClasses = function () {
    ...
    FlexView.prototype.render = function () {
        ...
        return (React.createElement("div", __assign({ className: className, style: style }, props), this.props.children));
    };
    FlexView.propTypes = {
